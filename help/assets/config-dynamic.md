...
1. Passa a [Distribuzione software](https://experience.adobe.com/#/downloads/content/software-distribution/it/aem.html) e scarica `cq-6.3.0-featurepack-12445`.
   ...
   Per ulteriori informazioni sull&#39;utilizzo dei pacchetti in [, vedere &#x200B;](/help/sites-administering/package-manager.md)Utilizzo dei pacchetti[!DNL Adobe Experience Manager].
