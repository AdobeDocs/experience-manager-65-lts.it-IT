...
1. Impostare le opzioni di runtime della crittografia.
   ...
   * Specificare l&#39;opzione di compatibilità di Acrobat assegnando un valore di enumerazione `PasswordEncryptionCompatibility` al membro dati `compatibility` dell&#39;oggetto `PasswordEncryptionOptionSpec`. Ad esempio, assegnare `PasswordEncryptionCompatibility.ACRO_7` a questo membro dati.
