...
PDF Generator converte vari formati di file in PDF. Converte inoltre i PDF in altri formati di file e ottimizza le dimensioni dei documenti PDF. Per un elenco dei formati di file supportati, consulta [Supporto software per PDF Generator](/help/sites-deploying/technical-requirements.md)
