...
>[!NOTE]
>
>Nelle distribuzioni del database di Oracle, i filtri per l’intervallo di date (ovvero, Ora di creazione e Prima delle impostazioni) non funzionano in modo preciso. Utilizzare un altro filtro per recuperare gli elementi di lavoro.
