...
1. Dopo aver installato e configurato l’ambiente AEM Forms con Document Security, imposta tutti i domini appropriati in Gestione utente. <!-- Fix broken link (See Setting up and managing domains) -->
...
**Estensioni DC di Acrobat Reader per Microsoft Office**
