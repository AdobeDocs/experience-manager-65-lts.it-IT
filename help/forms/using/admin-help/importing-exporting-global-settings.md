...
**client_pollingInterval:** Imposta l&#39;intervallo di polling (in secondi) utilizzato in (obsoleto per AEM forms su JEE) Flex Workspace per rilevare le attività nuove e modificate. Il valore predefinito è 3 secondi. Questa operazione non funziona per AEM Forms Workspace.
