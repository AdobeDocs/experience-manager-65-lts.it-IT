---
title: Proprietà configurazione gestione della corrispondenza
description: Questo argomento spiega come modificare Asset Composer con configurazioni specifiche per la soluzione.
...
# Proprietà configurazione gestione della corrispondenza {#correspondence-management-configuration-properties}
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Tipo di rappresentazione utilizzato dall'applicazione per eseguire il rendering dell'anteprima della lettera. </td>
   <td>Rappresentazione HTML</td>
   <td>Rappresentazione HTML/Rappresentazione PDF</td>
  </tr>
  <tr>
   <td><p>Abilita evidenziazione CCR PDF</p> </td>
   <td><p>Abilita l'evidenziazione su PDF nell'applicazione.</p> </td>
   <td><p>vero</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Tipo evidenziazione destinazione</p> </td>
   <td><p>Tipo di evidenziazione del target nell’applicazione.</p> </td>
   <td><p>bordo</p> </td>
   <td><p>bordo/riempimento/nessuno</p> </td>
  </tr>
  <tr>
   <td><p>Colore evidenziazione destinazione</p> </td>
   <td><p>Colore di evidenziazione destinazione nell’applicazione.</p> </td>
   <td><p>90;155;245</p> </td>
   <td><p>Qualsiasi colore RGB in formato R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Tipo evidenziazione contenuto</p> </td>
   <td><p>Tipo di evidenziazione del contenuto nell’applicazione.</p> </td>
   <td><p>Riempimento</p> </td>
   <td><p>bordo/riempimento/nessuno</p> </td>
  </tr>
  <tr>
   <td><p>Colore evidenziazione contenuto</p> </td>
   <td><p>Colore di evidenziazione contenuto nell’applicazione.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Qualsiasi colore RGB in formato R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Tipo evidenziazione campo</p> </td>
   <td><p>Tipo di evidenziazione campo nell’applicazione.</p> </td>
   <td><p>riempimento</p> </td>
   <td><p>bordo/riempimento/nessuno</p> </td>
  </tr>
  <tr>
   <td><p>Colore evidenziazione campo</p> </td>
   <td><p>Colore di evidenziazione campo nell’applicazione.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Qualsiasi colore RGB in formato R;G;B</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Tipo di invio PDF (tipo di PDF generato all’invio dall’applicazione).</p> </td>
  ...
  <tr>
   ...
   <td><p>Specifica un formato di visualizzazione specifico della lingua per i dati.</p> </td>
  ...
  <tr>
   ...
   <td><p>Modifica il formato dei dati. Utilizzato quando si scrivono dati come stringa o si analizzano dati da stringa.</p> </td>
  ...
  <tr>
   ...
   <td><p>Attiva/disattiva la funzionalità Lettera (applicabile solo al server di pubblicazione).</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Abilita controllo</p> </td>
   <td><p>Attiva/disattiva la funzionalità di controllo. Se è false, i registri di audit per tutte le azioni sono disabilitati.</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Abilita/disabilita la funzionalità di controllo per la creazione di risorse.</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Abilita controllo aggiornamento</p> </td>
   <td><p>Abilita/disabilita la funzionalità di controllo per l’aggiornamento delle risorse.</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Attiva/disattiva la funzionalità di controllo per la pubblicazione delle risorse.</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Attiva/disattiva la funzionalità di controllo per l'invio di lettere per posta elettronica.</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Specifica il numero massimo di lettere da mantenere nella cache.</p> <p>La modifica di questo valore determina la pulizia della cache di <code>in-memory</code>.</p> </td>
   <td><p>100</p> </td>
   <td><p>Qualsiasi valore numerico</p> </td>
  </tr>
  <tr>
   <td><p>Abilita cache lettere</p> </td>
   <td><p>Attiva/disattiva la cache delle lettere.</p> <p>La modifica di questo valore determina la pulizia della cache di <code>in-memory </code>.</p> </td>
   <td><p>vero</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Ordinamento elementi dati</p> </td>
   <td><p>Mantiene l’ordine degli elementi dati nell’interfaccia in base alla loro sequenza in Letter.</p> </td>
   <td><p>vero</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Ricaricamento supporto</p> </td>
   <td><p>Abilita/disabilita il supporto per il ricaricamento nelle lettere sottoposte a rendering sul lato server.</p> <p>La disattivazione migliora le prestazioni di rendering delle lettere.</p> </td>
   <td><p>false</p> </td>
  ...
  <tr>
   ...
   <td>Opzioni di compatibilità del formato nomeconfigurazione : configvalue separate da virgola.</td>
   <td>acm.compatibilityOptions</td>
   <td> </td>
  </tr>
  <tr>
   <td><p>Directory di debug </p> <p> </p> </td>
   <td>Percorso della cartella del file system per il debug. Se la directory non <code>exists</code>, non vengono generate immagini di debug.</td>
