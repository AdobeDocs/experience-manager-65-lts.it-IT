...
**Condizione-Azione** In questo costrutto, un regola definisce prima una condizione seguita da un&#39;azione di attivazione. Il costrutto è paragonabile a quello dei linguaggi di `if-then statement` programmazione.
...
* Assicurati che il [componente principale e la versione delle specifiche siano impostati sulla versione](https://github.com/adobe/aem-core-forms-components/tree/release/650) più recente per utilizzare questa funzione nel regola editor.
...
Esempio di Set Valore regola utilizzando il servizio Form Data Model.
