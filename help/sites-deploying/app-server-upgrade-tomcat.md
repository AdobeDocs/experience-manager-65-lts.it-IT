...
# Passaggi per l&#39;aggiornamento delle installazioni di Application Server (Tomcat - Sidegrade) {#upgrade-steps-for-application-server-installations-tomcat}

>[!NOTE]
>
>Questa pagina illustra la procedura di aggiornamento da AEM 6.5 a AEM 6.5 LTS su Tomcat. Per l&#39;aggiornamento da AEM 6.5 LTS a AEM 6.5 LTS Servicepack [fare riferimento a questo](/help/sites-deploying/app-server-upgrade-tomcat-inplace.md)
