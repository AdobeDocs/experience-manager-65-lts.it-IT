...
+ Forms {#forms}
   ...
   + Installare e configurare AEM Forms {#install-aem-forms}
      ...
      + Installare AEM Forms su JEE {#jee-installation}
         ...
         + [Installazione e distribuzione di AEM Forms 6.5 LTS su JEE tramite JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-turnkey.pdf)
         + [Installazione e distribuzione di AEM Forms in JEE per JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-jboss.pdf)
   ...
   + Aggiornare AEM Forms {#upgrade-aem-forms}
      ...
      + Aggiornare AEM Forms su OSGi {#aem-forms-osgi-upgrade}
         ...
         + [Aggiornamento di AEM 6.5 LTS su JBoss EAP 8 (Windows)](/help/forms/using/upgrading-aem-6.5-lts-on-jboss-eap-8)
      + Aggiornare AEM Forms su JEE {#aem-forms-jee-upgrade}
         + [Aggiornamento a AEM Forms 6.5 LTS su JEE per JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-turnkey.pdf)
   ...
   + App AEM Forms {#aem-forms-app}
      ...
      + [Configurare Android](/help/forms/using/setup-android-studio-project-build-installer.md)
      + [Creare AEM Forms Android](/help/forms/using/setup-eclipse-project-build-installer.md)
   ...
   + Guida per gli amministratori di AEM Forms su JEE {#administrator-help}
      ...
      + Connessione a un sistema di gestione dei contenuti {#connect-content-management-system}
         ...
         + [Configurazione del connettore per IBM](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
         + [Configurazione del connettore per IBM](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      ...
      + Configurazione di SSL {#configure-ssl}
         ...
         + [Configurazione di SSL per JBoss](/help/forms/using/admin-help/configuring-ssl-for-jboss-application-server-aem-forms-6.5-lts-jee.md)
         + [Configurazione SSL in Windows Vista](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
         + [Configurazione di SSL per WebSphere](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
      ...
      + Configurazione di Forms Workflow{#configure-forms-workflow}
         ...
         + [Panoramica di Forms Workflow](/help/forms/using/admin-help/overview-9.md)
      ...
      + Manutenzione del server applicazioni {#manage-application-server}
         ...
         + [Avvio e arresto di WebSphere](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + Backup e ripristino di AEM Forms {#aem-forms-backup-recovery}
         + [Backup e ripristino di EMC Documentum](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
         ...
         + [Strategia di backup per Connector per EMC Documentum](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
   ...
   + Riferimenti per sviluppatori {#developer-reference}
      ...
      + Programmazione con AEM Forms su JEE {#programming-aem-forms-jee}
         ...
         + Esecuzione di operazioni del servizio tramite API {#performing-service-operations-using-apis}
            ...
            + [Utilizzo del codice a barre di Forms](/help/forms/developing/barcoded-forms.md)
   ...
   + Risoluzione di problemi {#troubleshooting}
      ...
      + [Elaborazione di documenti anche se AEM Forms Server non è completamente operativo](/help/forms/using/processing-documents-even-if-aem-forms-server-not-fully-up.md)
      ...
      + [Esecuzione dello script non riuscita in AEM Forms 6.5 LTS con JBoss EAP 8 (Linux)](/help/forms/using/script-execution-issues-on-aem-forms-6.5-lts-with-jboss-eap-8-linux.md)
...
+ Implementazione {#implementing}
   + Sviluppo {#developing}
      ...
      + Gestione delle esperienze headless {#headless}
         ...
         + Percorsi headless {#journeys}
            + Percorso per sviluppatori headless {#developer}
               + [Comprendere headless in AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html?lang=it)
               ...
               + [Guida introduttiva ad AEM as a Cloud Service headless](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/getting-started.html?lang=it)
               ...
               + [Accedere al contenuto tramite API di consegna AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/access-your-content.html?lang=it)
               + [Aggiornare il contenuto tramite API di AEM Assets](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/update-your-content.html?lang=it)
               ...
               + [Pubblicare tramite la tua applicazione headless](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html?lang=it)
            ...
            + Percorso di architettura dei contenuti headless {#architect}
               + [Panoramica del percorso architetto di contenuti headless di AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/overview.html?lang=it)
               ...
               + [Scopri come creare modelli frammento di contenuto in AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/model-structure.html?lang=it)
         ...
         + Frammenti di contenuto{#content-fragments}
            ...
            + [Abilitare la funzionalità Frammento di contenuto per un’istanza](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-configuration-browser.html?lang=it)
         ...
         + API di distribuzione{#delivery-api}
            ...
            + [API GraphQL per AEM con frammenti di contenuto - Contenuto di esempio e query](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/content-fragments-graphql-samples.html?lang=it)
      ...
      + Best practice {#bestpractices}
         ...
         + [Linee guida e best practice per lo sviluppo AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/introduction/dev-guidelines-bestpractices.html?lang=it)
   ...
   + Implementazione {#deploying}
      ...
      + Aggiornamento a AEM 6.5 LTS {#upgrading}
         ...
         + [Compatibilità con le versioni precedenti in AEM 6.5 LTS](/help/sites-deploying/backward-compatibility.md)
