...
Per ulteriori informazioni, vedere il pacchetto del sito di riferimento [Adobe Learning Manager (sito di riferimento ALM) per AEM Sites](https://experienceleague.adobe.com/it/docs/learning-manager/using/integration/aem-sites/adobe-learning-manager-integration-aem).
