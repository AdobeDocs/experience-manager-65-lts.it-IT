...
1. Nella pagina **Gruppi di utenti** per l’**Assistente IA in AEM**, fai clic sulla scheda **Utenti**, quindi su **Aggiungi utenti**.
   ...
   ![Pagina dei gruppi di utenti dell’Assistente IA in AEM, con la scheda Utenti e il pulsante Aggiungi utenti](/help/assets/assets-ai/ai-assistant-add-users.png)
