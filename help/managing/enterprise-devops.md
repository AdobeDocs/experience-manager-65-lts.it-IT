...
* Solo a questo punto il codice può essere implementato negli ambienti di produzione.
...
* Manualmente: le implementazioni negli ambienti di staging e di produzione sono effettuate in modo più controllato, spesso manuale; tuttavia, qualora sia necessario, è possibile ricorrere all’automazione.
